...
RSpec.describe 'have_attributes matcher' do
  describe ProfessionalWrestler.new('Stone Cold Steve Austin', 'Stunner') do
    it 'checks for object attribure and proper values' do
    ...
    it { is_expected.to have_attribute(name: 'Stone Cold Steve Austin') }
    it { is_expected.to have_attribute(name: 'Stone Cold Steve Austin', finishing_move: 'Stunner') }
  end
end
